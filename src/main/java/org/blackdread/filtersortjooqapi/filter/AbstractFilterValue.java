...
import org.blackdread.filtersortjooqapi.filter.keyparser.KeyParsers;
...
public abstract class AbstractFilterValue implements FilterValue {
    ...
    private Condition throwIfConditionIsNull(final Condition condition, final String message) {
        if (condition == null)
